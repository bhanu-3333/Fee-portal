    ...
    return (
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '20px' }}>
          {years.map(y => (
            <div key={y._id} onClick={() => openYear(y)} className="glass card" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '15px' }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '20px' }}>
        {departments.map(d => (
          <div key={d._id} onClick={() => openDepartment(d)} className="glass card" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '15px' }}>
